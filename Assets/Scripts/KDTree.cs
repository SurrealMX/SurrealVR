...
//From: https://forum.unity.com/threads/point-nearest-neighbour-search-class.29923/
...
//	Get a point's distance from an axis-aligned plane.
	...
	void SearchK(Vector3 pt, HashSet<int> p_pivotIndexSet, ref float bestSqSoFar, ref float minSqDist, ref int bestIndex) {
		...
		if (lr[selector] != null) {
			lr[selector].SearchK(pt, p_pivotIndexSet, ref bestSqSoFar,ref minSqDist, ref bestIndex);
		}
